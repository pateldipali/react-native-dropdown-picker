...
class DropDownPicker extends React.Component {
    constructor(props) {
        ...
        this.state = {
            choice: props.multiple ? items : choiceobj,
            searchableText: null,
...
DropDownPicker.defaultProps = {
    ...
    showArrow: true,
    arrowSize: 15,
    customArrowUp: (size, color) => <Feather name="chevron-up" size={size} color={color} />,//<Feather name="chevron-up" size={size} color={color} />,
    customArrowDown: (size, color) => <Feather name="chevron-down" size={size} color={color} />,//<Feather name="chevron-down" size={size} color={color} />,
    customTickIcon: () => <Feather name="check" size={15} />,//<Feather name="check" size={15} />,
    zIndex: 5000,
    disabled: false,
    searchable: false,
